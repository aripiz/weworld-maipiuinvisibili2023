...
layout = html.Div([
        ...
        dbc.Row([
            dbc.Col([
                ...
                dbc.ListGroup([
                    dbc.ListGroupItem("Valuta il progresso dei territori alla luce delle condizioni di inclusione che riescono a garantire alle categorie più vulnerabili: donne, bambini e adolescenti.",),# color="#FFF8B2"),
                    dbc.ListGroupItem("Tiene conto delle condizioni di donne e minori in maniera congiunta, interdipendente e simultanea, riconoscendo un nesso tra l’implementazione dei diritti di una categoria sul benessere dell’altra e viceversa.",), # color="#E0F2FD"),
                    dbc.ListGroupItem("Considera il concetto di inclusione al di là di un’accezione dello sviluppo puramente economicistica, aprendo a una visione ampia, multidimensionale, dinamica e positiva, personale, sociale e intersezionale, universale.",)# color='#B8DCCA') #(in linea con l’Agenda 2030 e le cosiddette 5P: People, Planet, Prosperity, Partnership, Peace)
                ], flush=False)
            ], lg = 6, xs = 12),
